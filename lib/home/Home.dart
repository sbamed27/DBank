        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              FittedBox(child: Image.asset('assets/phone/background/1576.png'))
            ],
          ),
        ),
        SizedBox(height: 46),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Everywhere access',
                      style:
                          TextStyle(fontSize: 22.sp, fontFamily: 'Gilroy Bold'),
                    ),
                    Text(
                      'can access from all devices, everywhere access\neverywhere access anywhere access',
                      style:
                          TextStyle(fontSize: 8.sp, fontFamily: 'Gilroy Light'),
                    )
                  ],
                ),
                SizedBox(
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 25.sp, fontFamily: 'Gilroy Bold'),
                ),
                Column(
                  children: [
                    Text(
                ...
                Column(
                  ...
                  children: [
                    TextButton.icon(
                      ...
                      style: ButtonStyle(
                          fixedSize: MaterialStateProperty.all(Size(230.w, 60)),
                          backgroundColor:
